# :warning: This code is to help better understand the library architecture, to aid the rewrite. !DO NOT USE! :warning:
This likely does not even run a little bit
